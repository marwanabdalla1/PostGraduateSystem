<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NonGucianRegister.aspx.cs" Inherits="MS3.NonGucianRegister" %>
...
&nbsp;<asp:Label ID="Label2" runat="server" Text="Last Name:"></asp:Label>
        ...
        :&nbsp;
        <asp:TextBox ID="Address" runat="server" Width="193px"></asp:TextBox>
        <br />
        <br />
